...
def ntarefas():
    ...
    cb_categoria = Combobox(ecra_ntarefas, state="readonly", values=lista_categorias, text="Categorias")
    ...
    cb_estado = Combobox(ecra_ntarefas, state="readonly", values=lista_estados, textvariable=einicial)
