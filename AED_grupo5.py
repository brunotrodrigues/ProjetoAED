...
def login():
    ...
    Button(ecra_login, text="Login", background="skyblue1", command = login_ver).place(x=200, y=150)
...
def main_account_screen():
    ...
    Button(text="Login", height="2", width="30", background="skyblue1", command = login).place(x=50, y=50)
    Button(text="Registar", height="2", width="30", background="skyblue1", command = registar).place(x=50, y=100)
